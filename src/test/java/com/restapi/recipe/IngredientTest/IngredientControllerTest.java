...
public class IngredientControllerTest {
    ...
    void saveIngredientTest() throws Exception {
        ...
        //when
        ResultActions response = mockMvc.perform(post("/ingredient")
    ...
    void getIngredientsTest() throws Exception {
        ...
        //when
        ResultActions response = mockMvc.perform(get("/ingredient")
    ...
    void getIngredientByIdTest() throws Exception {
        ...
        //when
        ResultActions response = mockMvc.perform(get("/ingredient/{id}", ingId));
        //then
        response.andExpect(status().isOk())
                .andDo(print())
    ...
    void updateIngredientTest() throws Exception {
        ...
        //when
        ResultActions response = mockMvc.perform(put("/ingredient/{id}", ingId)
                .contentType(MediaType.APPLICATION_JSON)
